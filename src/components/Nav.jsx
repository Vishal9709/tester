...
function Nav() {
  ...
  return (
    <div className='w-full h-[100px] flex justify-between items-center px-5 md:px-8'>
        <div>vishal keshri</div>
        <div className='w-[60px] h-[60px] bg-white flex justify-center items-center rounded-md shadow-xl'>
           <MdFastfood className='w-[30px] h-[30px] text-orange-500' />
        </div>

        <form className='w-[45%] h-[60px] bg-white flex items-center px-[20px] gap-5 rounded-md shadow-md md:w-[70%]' onSubmit={(e)=>e.preventDefault()}>
          <IoSearch className='text-[20px] text-orange-500'/>
